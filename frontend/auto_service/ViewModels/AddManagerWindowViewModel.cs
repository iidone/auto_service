...
public class AddManagerWindowViewModel : ReactiveObject
{
    ...
    public AddManagerWindowViewModel(MasterService masterService, IWindowService window_service, Window currentWindow)
    {
